...
class ExperimentWaffleFlag(CourseWaffleFlag):
    ...
    Note that you may called `.get_bucket` without a course_key, in which case:
    * the smaller flags will be evaluated without course context, and
    * the defauult bucket will be evaluated as if use_course_aware_bucketing=True.
    ...
    def get_bucket(self, course_key=None, track=True):
        ...
        if course_key:
            ...
            if self.use_course_aware_bucketing:
